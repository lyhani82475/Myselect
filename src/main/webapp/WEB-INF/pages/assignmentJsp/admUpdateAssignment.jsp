...
<div id="popBox">
    ...
    <div class="content">
        ...
        <br />
        <span style="font-family:仿宋; font-size:16pt; color:#009">  &nbsp;&nbsp;如果任务书中的“主要内容”、“要求及要完成的工作”、“参考文献”没有全部显示在页面上的话，可点击键盘上的↓键</span>
    </div>
</div>
<br/>
...
<script type="text/javascript">
    function updateAssignment() {
        ...
        form.action = "<%=basePath %>assignment/admUpdateAssignment";
        form.method = "post";
        form.submit();

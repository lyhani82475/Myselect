...
<c:forEach var="registration" items="${requestScope.get('list')}" varStatus="status" end="0">
    <div>
        ...
        <p style="margin:0pt; orphans:0; text-align:center; widows:0">
            ...
            <span style="font-family:宋体; font-size:12pt; font-weight:bold"><input style="text-align:left" readonly="readonly" name="registrationFaculty" style="width:180pt" type="text" value="${registration.registrationFaculty}"/></span>
            <span style="font-family:宋体; font-size:12pt; font-weight:bold">专业班级：</span>
            <span style="font-family:宋体; font-size:12pt; font-weight:bold"><input style="text-align:left" readonly="readonly" name="registrationMajor" style="width:180pt" type="text" value="${registration.registrationMajor}"/></span>
...
<script type="text/javascript">
    function lookRegistration() {
        ...
        form.action = "<%=basePath %>registration/admLookRegistration";
        form.method = "post";
        form.submit();
